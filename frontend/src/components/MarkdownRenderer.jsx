    ...
    <ReactMarkdown
      components={{
        ...
        pre: ({ node, children, ...props }) => (
          <div className="not-prose rounded-xl overflow-hidden mb-4 border border-slate-200 dark:border-slate-800 bg-[#0d1117]">
            ...
            <div className="p-4 overflow-x-auto">
              <pre className="text-sm font-mono text-slate-300 bg-transparent p-0 m-0 border-none" {...props}>
                {children}
              </pre>
            </div>
          </div>
